...
@router.get("/alumnos_H")
async def alumnos_H():
    return (users_list)

@router.post("/alumnos_H", response_model=User, status_code=status.HTTP_201_CREATED)
async def alumnos_H(user:User):
...
@router.delete("/alumnos_H/{id}")
async def alumnos_H(id:int):
