...
@router.get("/alumnos_J")
async def alumnos_J():
    return (users_list)

@router.post("/alumnos_J", response_model=User, status_code=status.HTTP_201_CREATED)
async def alumnos_J(user:User):
...
@router.delete("/alumnos_J/{id}")
async def alumnos_J(id:int):
