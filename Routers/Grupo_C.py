...
@router.get("/alumnos_C")
async def alumnos_C():
    return (users_list)


@router.post("/alumnos_C", response_model=User, status_code=status.HTTP_201_CREATED)
async def alumnos_C(user: User):
...
@router.delete("/alumnos_C/{id}")
async def alumnos_C(id: int):
