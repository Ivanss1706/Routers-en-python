...
@router.get("/alumnos_I")
async def alumnos_I():
    return (users_list)


@router.post("/alumnos_I", response_model=User, status_code=status.HTTP_201_CREATED)
async def alumnos_I(user: User):
