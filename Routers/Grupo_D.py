...
@router.get("/alumnos_D")
async def alumnos_D():
    return (users_list)

@router.post("/alumnos_D", response_model=User, status_code=status.HTTP_201_CREATED)
async def alumnos_D(user:User):
...
@router.delete("/alumnos_D/{id}")
async def alumnos_D(id:int):
