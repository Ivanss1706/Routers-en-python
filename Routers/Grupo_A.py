...
@router.get("/alumnos_A")
async def alumnos_A():
    return (users_list)


@router.post("/alumnos_A", response_model=User, status_code=status.HTTP_201_CREATED)
...
@router.delete("/alumnos_A/{id}")
async def alumnos_A(id: int):
